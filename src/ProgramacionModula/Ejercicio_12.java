...
public class Ejercicio_12 {
		...
		public static int pedirAnno(){
			...
			do {
				...
				if(!annoValido) {
					System.out.println("ERROR. Introduce un a�o correcto (mayor o igual que 1582)");
				}
			}while(!annoValido);
			return anno;
		}
		...
		public static boolean validarDia(int dia, int mes, int anno){
			...
			switch(mes)
			{
				...
				case 11:
					...
					if(!diaValido) {
						System.out.println("ERROR. Introduce un d�a valido entre 1 y 30");
					}
					break;
				case 1:
				case 3:
				...
				case 12:
					...
					if(!diaValido) {
						System.out.println("ERROR. Introduce un d�a valido entre 1 y 31");
					}
					break;
				case 2:
					if(esBisiesto(anno)) {
						...
						if(!diaValido) {
							System.out.println("ERROR. Introduce un d�a valido entre 1 y 29");
						}
					}else {
						diaValido = (dia>1 && dia<=28);
						if(!diaValido) {
							System.out.println("ERROR. Introduce un d�a valido entre 1 y 28");
						}
					}
